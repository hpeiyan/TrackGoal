...
import club.peiyan.goaltrack.pay.OrderInfoUtil2_0;
import club.peiyan.goaltrack.pay.PayResult;

import static club.peiyan.goaltrack.data.Constants.APPID;
import static club.peiyan.goaltrack.data.Constants.RSA2_PRIVATE;
import static club.peiyan.goaltrack.data.Constants.RSA_PRIVATE;
...
public class AboutActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        EnvUtils.setEnv(EnvUtils.EnvEnum.SANDBOX);//测试下沙箱模拟
